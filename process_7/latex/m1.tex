...
\INVARIANTS{
	...
	\Invariant{inv6}{false}{$\forall{}t,p\qdot{}(p\in{}wait \land{} p\in{}dom(t1) \land{} t=t1(p))\limp{}clk-t\leq{}ddl1$}{\\deadline(t1,t2,ddl1)}
	\Invariant{inv8}{false}{$\forall{}p\qdot{}(p\in{}dom(t1)\land{}p\in{}dom(t2)\land{}t2(p)\geq{}t1(p))\limp{}t2(p)-t1(p)\leq{}ddl1$}{}
	\Invariant{inv13}{false}{$\forall{}t,p\qdot{}(p\in{}process \land{} p\in{}dom(t1) \land{} t=t1(p))\limp{}clk-t\leq{}ddl3$}{\\deadline(t1,t3,ddl3)}
	\Invariant{inv14}{false}{$\forall{}p\qdot{}(p\in{}dom(t1)\land{}p\in{}dom(t3)\land{}t3(p)\geq{}t1(p))\limp{}t3(p)-t1(p)\leq{}ddl3$}{}
	...
	\Invariant{inv15}{false}{$\forall{}t,p\qdot{}(p\in{}process \land{} p\in{}dom(t1) \land{} t=t1(p))\limp{} p\in{}dom(t2) \land{} t2(p)\geq{}t1(p)$}{}
}
\EVENTS{
\INITIALISATION{true}{}{
	\ACTIONS{false}{
...
\EVT{tick}{false}{ordinary}{}{}{
	\GUARDS{false}{
		...
		\Guard{grd3}{false}{$\forall{}t,p\qdot{}(p\in{}process \land{} p\in{}dom(t1) \land{} t=t1(p))\limp{}clk+1-t\leq{}ddl3$}{true}{}
	}
	\ACTIONS{true}{
