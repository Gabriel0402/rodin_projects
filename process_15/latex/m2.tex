...
\EVT{enter}{true}{ordinary}{enter}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd4}{false}{$pro=queue(1)$}{true}{}
	}
	\ACTIONS{true}{
		...
		\Action{act4}{$queue\bcmsuch{}queue'\in{}1\upto{}qsize-1\tbij{}wait\setminus{}\{queue(1)\}\land{}(\forall{}i\qdot{}i\in{}1\upto{}qsize-1\limp{}queue'(i)=queue(i+1))$}{true}{}
